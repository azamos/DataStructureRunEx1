...
int main() {
    ...
    for (int j = 0; j < num_arrays; j++) {
        int n = rand() % 101 + 150; // Generate n in (150, 250)
        ...
        int res1 = f1(input_array, 1000, randomNum);
        int res2 = f2(input_array, 1000, randomNum);
        if (res1 != res2) {
